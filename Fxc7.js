...
const { help, bahasa, donasi, bottt } = require('./Fxc7/help')
...
prefix = "!"
name = "~ MAULANA ABDUL IHSAN P"
rdaftar = "TERIMA KASIH TELAH DAFTAR MENJADI TEMEN �꙱./P4luvi�꙱😁"
rmenu = "HAI TEMEN �꙱./P4luvi�꙱👋 JANGAN LUPA DONASI YAA:)"
...
async function starts() {
	...
	frhan.on('chat-update', async (mek) => {
		try {
			...
			const FarhanGans = ["6287871537199@s.whatsapp.net"] // ubah aja gapapa
		...
		case 'daftar':
         ...
         case 'lirik':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                    ...
                    frhan.sendMessage('6287871537199@s.whatsapp.net', options, text, {quoted: mek})
